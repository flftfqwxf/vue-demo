...
function initUEditor(id, textlength, zIndex, touristLineId, maxScaleEnaledWidth, maxScaleEnaledHeight){
    ...
    var ue = window.UE.getEditor(id,{
        ...
        toolbars: ((null != recentlyuse_url && "" != recentlyuse_url)?
            [['FullScreen', 'Undo','Bold','forecolor','insertorderedlist','insertunorderedlist','diyupload','cleardoc','recentlyuse']]
            :[['FullScreen', 'Undo','Bold','forecolor','insertorderedlist','insertunorderedlist','diyupload','cleardoc']]),
        //focus时自动清空初始化时的内容
