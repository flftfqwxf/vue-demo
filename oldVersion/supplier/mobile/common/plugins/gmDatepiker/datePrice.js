		...
		_defaultDates: function(options, obj, thisDate){
			...
			for(var i = fDay; i <= lastDay; i++){
				...
				if(options.preDataDisabled && now>Date.parse(new Date(year,(month*1-1),i+1))){
					disaabledStr=' style="color:#ccc!important;"';
				}else{
					disaabledStr='';
				}
				str += '<td><div class="td_content" id="'+this.options.dayTdIdFix+i+'"><p class="dayNumber" '+disaabledStr+'>'+i+'</p>';
