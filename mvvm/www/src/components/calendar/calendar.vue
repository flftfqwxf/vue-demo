<template>
    <div @click.stop=""  @touchstart.stop="" class="calendar" v-show="show" :style="{'left':x+'px','top':y+'px',zIndex:zIndex}" transition="calendar" transition-mode="out-in">
        ...
        <div class="calendar-button" v-show="type=='datetime'||type=='time'||range">
            ...
            <button @click.prevent="cancel" class="cancel">取消</button>
        </div>
    </div>
</template>
