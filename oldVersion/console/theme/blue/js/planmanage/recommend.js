...
$(function(){
	...
	$(".checkBtn").click(function(){
		...
		var cover_pv=$this.parent().nextAll(".cover_pv").find("span");
		if(value!=""){
			var toset = true;
			/**
			...
			if(toset){
				...
				if(oldValue!=value){
					update = true;
					$this.parent().find(".query_warning").remove();
					$.ajax({
						...
						success:function(json){
							...
							if(json.product){
								...
								cover_pv.text(product.statistics.itemPageViewWeek+product.statistics.productPageViewWeek );    //封面推荐pv数
