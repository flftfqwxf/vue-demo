    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                data["token"] = editor.getOpt('uptoken')
                console.log('imgjs:', editor.getOpt('uptoken'))
            });
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    var responseText = (ret._raw || ret),
                        response_json = utils.str2json(responseText);
                    var state = (response_json.key && response_json.hash) ? 'SUCCESS' : response_json.error;
                    var json = {
