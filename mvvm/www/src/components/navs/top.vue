<template>
    <div class="page-title clearfix" id="page-title-viewport">
        <div class="pull-left">
            ...
            <h2>
                分销商管理中心 - {{userInfo.distributor && userInfo.distributor.name}}
                <small>
                    <template v-if="userInfo.supplier">
                        <i class="fa fa-retweet"></i><a href="{{WEB_DISTRIBUTOR }}">供应商管理中心</a>
                    </template>
                    <template v-else>
        ...
        <ul class="pull-right login-state">
            <li class="dropdown" data-toggle="mouseenter">
                ...
                <ul class="dropdown-menu">
                    ...
                    <template v-else>
                        <li><a href="{{WEB_WWW }}/register-detail"><i class="gm-icon gm-supplier"></i>申请供应商</a></li>
                    </template>
